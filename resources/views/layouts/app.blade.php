			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<ul class="navbar-nav mr-auto">
						{{-- 「本」と「ユーザー」へのリンク --}}
						<li class="nav-item @if (my_is_current_controller('books')) active @endif">
							<a class="nav-link" href="{{ url('books') }}">
								{{ __('Books') }}
								@if (my_is_current_controller('books'))
					...
					<ul class="navbar-nav ml-auto">
						{{-- 投稿ボタン --}}
						<li class="nav-item">
							<a href="{{ url('books/create') }}" id="new-book" class="btn btn-success">
								{{ __('New Book') }}
							</a>
						</li>
